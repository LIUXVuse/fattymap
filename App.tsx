        ...
        <div className="relative w-screen h-screen overflow-hidden flex bg-gray-100 text-gray-800 font-sans">
            ...
            {!isAgeVerified && (
                <div className="fixed inset-0 z-[9999] bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
                    <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-700 max-w-md w-full p-8 text-center transform animate-in zoom-in-95 duration-300">
                        {/* Header Image */}
                        <div className="mb-6">
                            <img
